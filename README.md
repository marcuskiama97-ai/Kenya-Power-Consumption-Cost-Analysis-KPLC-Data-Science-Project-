...
- Comparison of consumption across customer types (residential, commercial, industrial)  
- Simulated trends to forecast consumption at county and national levels  
...
- County level comparisons and heatmaps  
- Cost vs. consumption analysis  
- Distribution inefficiencies highlighted  

![Example Visualization](images/consumption_trends.png)

---

## **Live Demo & Deployment**

Check out the interactive dashboard here: [KPLC Power Pulse](https://kplc-powerpulse.lovable.app/)

**How to Explore:**  
- Navigate through regional consumption trends  
- Filter by customer type and county  
...
- Cleaned and standardized raw KPLC consumption datasets  
- Aligned county and customer type labels  
- Aggregated data for monthly, quarterly, and annual analysis  
- Simulated realistic trends for customer, county, and national consumption  
...
```bash
git clone https://github.com/your-username/kplc-consumption-analysis.git
